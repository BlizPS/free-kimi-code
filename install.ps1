...
Installs or updates the selected Kimi Code, Codex, Antigravity, and Claude Code UIs, then RTK and Lazy Developer $LazyDevVersion.
...
# Actual installation order: RTK → Lazy Developer → selected UI(s) (Kimi → Codex → Antigravity → Claude Code).
