...
for rel in ['plugin.json','package.json','plugin.yaml','opencode.json','openclaw.plugin.json','gemini-extension.json','.claude-plugin/plugin.json','.claude-plugin/marketplace.json','.codex-plugin/plugin.json','.cursor-plugin/plugin.json','.qoder-plugin/plugin.json','.github/plugin/plugin.json','.github/plugin/marketplace.json','.agents/plugins/marketplace.json','.devin-plugin/plugin.json','.grok-plugin/marketplace.json','scripts/lazydev.mjs','scripts/intelligence_smoke.mjs','runtime/intelligence-kernel.mjs','runtime/ui-intelligence.mjs','commands/lazydev.toml','commands/ui.md','skills','assets/free-kimi-code-logo.svg','GEMINI.md','AGENTS.md','CLAUDE.md','README.md','LICENSE','systems/ui/pro/index.mjs','systems/ui/pro/generator.mjs','systems/ui/pro/bm25.mjs','systems/ui/pro/reasoning.mjs','systems/ui/pro/stack-detect.mjs','systems/ui/pro/persist.mjs','systems/ui/pro/quality.mjs','systems/ui/pro/data/products.json','systems/ui/pro/data/styles.json','systems/ui/pro/data/patterns.json','systems/ui/pro/data/palettes.json','systems/ui/pro/data/typography.json','systems/ui/pro/data/motion.json','systems/ui/pro/data/ux.json','runtime/provider-resilience.mjs','systems/intelligence/reasoning-scaffold.mjs','systems/intelligence/SYSTEM.md']:
    need(rel)
...
for p in ROOT.rglob('*.json'):
    ...
    # Package/plugin version is 1.0.2; keep the Agent Plugins schema URL at its own schema revision.
    if isinstance(d,dict) and isinstance(d.get('version'), str) and d['version'] != '1.0.2':
...
if rp.get('name')!='lazy-developer' or rp.get('version')!='1.0.2': errors.append('root plugin.json identity/version mismatch')
