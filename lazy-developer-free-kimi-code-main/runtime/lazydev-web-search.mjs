...
const USER_AGENT = process.env.LAZYDEV_SEARCH_USER_AGENT || 'LazyDev/1.0.1';
...
rl.on('line', async (line) => {
  ...
  try {
    if (method === 'initialize') {
      process.stdout.write(`${reply(id, { protocolVersion: '2024-11-05', capabilities: { tools: {} }, serverInfo: { name: 'lazydev-search', version: '1.0.1' } })}\n`);
