...
if package.get("version")!="1.0.1": errors.append("package version is not 1.0.1")
...
print("PASS: adaptive intelligence kernel, 1.0.1 release identity, and release-word hygiene")
