...
for p in ROOT.rglob('*.json'):
    ...
    # Package/plugin version is 1.0.1; keep the Agent Plugins schema URL at its own schema revision.
    if isinstance(d,dict) and isinstance(d.get('version'), str) and d['version'] != '1.0.1':
...
if rp.get('name')!='lazy-developer' or rp.get('version')!='1.0.1': errors.append('root plugin.json identity/version mismatch')
